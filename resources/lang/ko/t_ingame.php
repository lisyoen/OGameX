...
OGame 스타터 지원',
    ...
    'admin' => [
        ...
        'home' => [
            'title'                         => '관리자 포털',
            'select_feature'                => '아래에서 관리 기능을 선택하세요.',
            'translations_title'            => '번역',
            'translations_desc'             => 'i18n 번역 파일 편집 (en/ko).',
            'user_management_title'         => '사용자 관리',
            'user_management_desc'          => '사용자 조회, 관리자 권한 부여/취소.',
            'coming_next_release'           => '다음 릴리스에 추가 예정',
            'coming_soon'                   => '곧 출시',
            'developer_shortcuts_title'     => '개발자 단축키',
            'developer_shortcuts_desc'      => '자원 치트, 사용자 전환, 디버그 도구.',
            'server_settings_title'         => '서버 설정',
            'server_settings_desc'          => '우주 이름, 속도, 기본 수입.',
            'fleet_timing_title'            => '함대 타이밍',
            'fleet_timing_desc'             => '함대 미션 시간 빨리감기 또는 감소.',
            'rules_legal_title'             => '규칙 & 법률',
            'rules_legal_desc'              => '게임 규칙, 약관, 개인정보 보호정책.',
            'server_administration_title'   => '서버 관리',
            'server_administration_desc'    => '다중계정 감지, 차단, 캐시.',
        ],
        'rules' => [
            'title'         => '규칙 & 법률',
            'tab_rules'     => '규칙',
            'tab_legal'     => '법률',
            'tab_privacy'   => '개인정보 보호정책',
            'tab_terms'     => '이용약관',
            'tab_contact'   => '문의',
            'save'          => '저장',
        ],
        'translations_show' => [
            'title'                     => '번역 관리 — :ns',
            'back_to_list'              => '← 목록',
            'stats_total_keys'          => '전체 키',
            'stats_translated'          => '번역 완료',
            'stats_untranslated'        => '미번역',
            'stats_mismatch'            => 'placeholder 불일치',
            'bulk_save'                 => '일괄 저장',
            'commit'                    => 'Commit',
            'table_key'                 => '키',
            'table_en_original'         => 'en 원문',
            'table_ko_translation'      => 'ko 번역',
            'table_placeholder'         => 'placeholder',
            'table_save'                => '저장',
            'status_initial'            => '초기 상태',
            'modal_title'               => 'Commit 수동 가이드',
            'modal_auto_commit_info'    => '자동 commit은 501 (미구현) 상태입니다. 아래를 spark-home에서 수동 실행하세요:',
            'modal_push_note'           => '현재 admin-translations 브랜치면 push는 030에서 일괄',
            'modal_automation_note'     => '자동화는 향후 업스트림 PR 후보(shell exec 보안 검토 필요).',
            'modal_close'               => '닫기',
        ],
        'server_settings' => [
            'title' => '서버 설정',
